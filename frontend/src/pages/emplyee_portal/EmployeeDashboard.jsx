...
//             setLast7Verified(Array.isArray(last7Data) ? last7Data : []);
//         } catch (err) { notify("Failed to load dashboard data", "error"); }
//         finally { setLoading(false); }
//     };
...
// // Status styles are provided by shared util `getStatusStyles`
...
//                         <td style={styles.td}>
//                             <div>To: <b>{c.submitted_to_name || '-'}</b></div>
//                             <div>By: <b>{c.created_by_name || '-'}</b></div>
//                         </td>
//                         <td style={styles.td}><b>{c.candidate_name}</b></td>
//                         <td style={styles.td} title={c.technology}>{truncate(c.technology, 100)}</td>
//                         <td style={styles.td}>{c.years_of_experience_manual || '0'} Yrs</td>
//                         <td style={styles.td}>
//                             {c.client_name || c.client_company_name || 'N/A'} {c.client_company_name ? `(${c.client_company_name})` : ''}
//                         </td>
//                         <td style={styles.td}>
//                             {c.vendor_name || ''} {c.vendor_company_name ? `(${c.vendor_company_name})` : ''}<br/>
//                             <small style={styles.subStatus}>{c.vendor_number || 'N/A'}</small>
//                         </td>
//                         <td style={styles.td}>
//                             ₹{c.vendor_rate} {c.vendor_rate_type || ''}
//                             <br/>
//                             <small style={styles.subStatus}>Client ₹{c.client_rate || '-'} {c.client_rate_type || ''}</small>
//                         </td>
//                         <td style={styles.td}>
//                             <div style={{display:'flex', alignItems:'center', gap:'8px'}}>
//                                 <span style={{...styles.badge, color: statusStyle.text, fontWeight: '800'}}>{c.main_status}</span>
...
//                     </thead>
//                     <tbody>
//                         {renderGroupedRows(pipelineCandidates)}
//                     </tbody>
//                 </table>
//             </Section>
...
//                     </thead>
//                     <tbody>
//                         {renderGroupedRows(verifiedCandidates)}
//                     </tbody>
//                 </table>
//             </Section>
...
//                             const statusStyle = getStatusStyles(c.main_status || 'SUBMITTED');
//                             return (
//                             <tr key={i} style={{...styles.tableRow, backgroundColor: statusStyle.bg}} onClick={() => navigate(`/employee/candidate/view/${c.id}`)}>
//                                 <td style={styles.td}>{c.created_by_name}</td>
//                                 <td style={styles.td}><b>{c.candidate_name}</b></td>
//                                 <td style={styles.td}>{truncate(c.technology, 100)}</td>
//                                 <td style={styles.td}>{c.years_of_experience_manual || "0"} Yrs</td>
//                                 <td style={styles.td}>{c.client || c.client_name || c.client_company_name || "N/A"}</td>
...
//                                         {c.client || c.client_name || c.client_company_name ? (
...
//                                 <td style={styles.td}><b>{truncate(c.vendor_name, 15)}</b><br/><small style={styles.subStatus}>{c.vendor_number || "N/A"}</small></td>
//                                 <td style={styles.td}>₹{c.vendor_rate} {c.vendor_rate_type || ""}</td>
//                                 <td style={styles.td}>
...
//                     </thead>
//                     <tbody>
//                         {last7Verified && last7Verified.length > 0 ? renderGroupedRows(last7Verified) : <tr><td colSpan="8" style={{textAlign:'center', padding:'18px'}}>No records found for last 7 days.</td></tr>}
//                     </tbody>
//                 </table>
//             </Section>
...
//     dateSeparator: { padding: "12px 20px", background: "#fff", color: "#475569", fontWeight: "800", fontSize: "12px", textTransform: "uppercase", borderBottom: '1px solid #eef2f6' },
