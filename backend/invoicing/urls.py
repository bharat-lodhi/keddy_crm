...
urlpatterns = [
    path("api/create/", views.CreateInvoiceAPIView.as_view(), name="create-invoice"),  #U
    ...
    path("api/clients/<int:id>/", InvoiceClientRetrieveUpdateAPIView.as_view()),  #update- acc details
